...
* [ashnkumar/sketch-code: Keras model to generate HTML code from hand-drawn website mockups. Implements an image captioning architecture to drawn source images.](https://github.com/ashnkumar/sketch-code)
